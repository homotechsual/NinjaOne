...
#Requires -Version 7
function Get-NinjaOneSoftwarePatchesReport {
    <#
        .SYNOPSIS
            Gets the software patches report from the NinjaOne API.
        .DESCRIPTION
            Retrieves the software patches report from the NinjaOne v2 API.
        .OUTPUTS
    ...
    try {
        ...
        $SoftwarePatchesReport = New-NinjaOneGETRequest @RequestParams
