<#
    .SYNOPSIS
        Core test suite for the NinjaRMM module.
#>
...
Describe 'Core' {
    ...
    It 'License URI is correct' {
        $Script:ModuleInformation.LicenseUri | Should -Be 'https://ninjarmmapi.mit-license.org/'
    }

    It 'Project URI is correct' {
        $Script:ModuleInformation.ProjectUri | Should -Be 'https://github.com/homotechsual/NinjaRMM'
    }
...
Describe 'Module NinjaRMM loads' {
    It 'Passed Module load' {
        Get-Module -Name 'NinjaRMM' | Should -Not -Be $null
    }
}