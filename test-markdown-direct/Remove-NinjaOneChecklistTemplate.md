...
```
Remove-NinjaOneChecklistTemplate [-checklistTemplateId] <Int32> [-ProgressAction <ActionPreference>] [-WhatIf]
...
### EXAMPLE 1
```
Remove-NinjaOneChecklistTemplate -checklistTemplateId 10 -Confirm:$false
```
