...
online version: https://docs.homotechsual.dev/modules/ninjaone/commandlets/Get/disksquery
schema: 2.0.0
---
...
```
Get-NinjaOneDisks [[-deviceFilter] <String>] [[-timeStamp] <DateTime>] [[-timeStampUnixEpoch] <Int32>]
...
[https://docs.homotechsual.dev/modules/ninjaone/commandlets/Get/disksquery](https://docs.homotechsual.dev/modules/ninjaone/commandlets/Get/disksquery)
