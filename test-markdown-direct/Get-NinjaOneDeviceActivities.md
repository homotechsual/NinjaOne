...
online version: https://docs.homotechsual.dev/modules/ninjaone/commandlets/Get/deviceactivities
schema: 2.0.0
---
...
```
Get-NinjaOneDeviceActivities [-deviceId] <Int32> [[-languageTag] <String>] [[-timezone] <String>]
...
[https://docs.homotechsual.dev/modules/ninjaone/commandlets/Get/deviceactivities](https://docs.homotechsual.dev/modules/ninjaone/commandlets/Get/deviceactivities)
