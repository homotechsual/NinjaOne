#
# Module manifest for module 'NinjaRMM'
#
...
@{
    ...
    Description = 'This module provides an interface to the NinjaRMM API.'
    ...
    FunctionsToExport = @(
        ...
        'Get-NinjaRMMDeviceOSPatchInstalls',
    ...
    PrivateData = @{
        ...
        PSData = @{
            ...
            LicenseUri = 'https://ninjarmmapi.mit-license.org/'

            # A URL to the main website for this project.
            ProjectUri = 'https://github.com/homotechsual/NinjaRMM'

            # A URL to an icon representing this module.
            IconUri = 'https://pbs.twimg.com/profile_images/1323282489620811782/BJMDdQVf_400x400.png'

            # ReleaseNotes of this module
            ReleaseNotes = 'Initial preview release of the NinjaRMM API PowerShell module.'
