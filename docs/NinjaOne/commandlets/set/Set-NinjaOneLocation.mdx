...
title: Set Location
id: location
description: "Sets location information using the NinjaOne v2 API."
hide_title: false
...
```powershell
Set-NinjaOneLocation [-organisationId] <Int32> [-locationId] <Int32> [-locationInformation] <Object> [-WhatIf]
