...
```powershell
Set-NinjaOneOrganisationPolicies [-organisationId] <Int32> [-policyAssignments] <Object[]> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```powershell
Set-NinjaOneOrganisationPolicies [-organisationId] <Int32> [-nodeRoleId] <Int32> [-policyId] <Int32> [-WhatIf]
