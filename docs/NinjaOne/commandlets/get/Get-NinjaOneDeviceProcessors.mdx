---
title: Get Device Processors
id: deviceprocessors
description: "Retrieves device processors from the NinjaOne v2 API."
hide_title: false
...
```powershell
Get-NinjaOneDeviceProcessors [-deviceId] <Int32> [<CommonParameters>]
```
