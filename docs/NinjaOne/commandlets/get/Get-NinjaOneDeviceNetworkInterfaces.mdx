---
title: Get Device Network Interfaces
id: devicenetworkinterfaces
description: "Retrieves device network interfaces from the NinjaOne v2 API."
hide_title: false
...
```powershell
Get-NinjaOneDeviceNetworkInterfaces [-deviceId] <Int32> [<CommonParameters>]
```
