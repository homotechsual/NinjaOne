---
title: Get Device Volumes
id: devicevolumes
description: "Retrieves device volumes from the NinjaOne v2 API."
hide_title: false
...
```powershell
Get-NinjaOneDeviceVolumes [-deviceId] <Int32> [[-include] <String>] [<CommonParameters>]
```
