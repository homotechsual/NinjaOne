---
title: New Organisation Documents
id: organisationdocuments
description: "Create one or more organisation documents using the NinjaOne v2 API."
hide_title: false
...
```powershell
New-NinjaOneOrganisationDocument [-organisationDocuments] <NinjaOneOrganisationDocument[]> [-show] [-WhatIf]
